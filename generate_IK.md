...
-----------------------------------------------------------------------------------------------
PEMAHAMAN DASAR INFORMASI KHUSUS ( INFOSUS ):

Infosus (sering juga disebut Lap Info / Insus) adalah dokumen pelaporan intelijen yang disusun berdasarkan apa yang dilihat, didengar, dan dirasakan langsung oleh personel di lapangan mengenai satu bidang atau satu masalah spesifik.

Karakteristik Utama: Sangat rahasia, spesifik, dan biasanya berkaitan dengan target yang memiliki risiko tinggi. Informasi ini disertai dengan penyajian fakta-fakta yang diurai secara sistematis beserta analisis singkat dari pembuat laporan.

Isi Laporan: Mengupas tuntas satu isu intelijen yang sensitif. Misalnya, laporan mengenai pergerakan kelompok kriminal bersenjata, dugaan penyalahgunaan wewenang oleh oknum tertentu, atau identifikasi awal sebelum dilakukannya Operasi Tangkap Tangan (OTT).

Sifat: Tidak terikat pada kejadian harian, melainkan dibuat ketika personel intelijen berhasil menggali informasi penting yang krusial untuk operasi atau kebijakan strategis.


Fokus Utama : Satu isu, target, atau masalah spesifik yang bersifat rahasia.

Tujuan : Memberikan data matang dan fakta di lapangan untuk perencanaan operasi intelijen atau penyelidikan lebih lanjut.

Karakteristik Waktu : Dibuat kapan saja (insidentil) ketika intelijen mendapatkan informasi atau fakta krusial yang valid.

Tingkat Sensitivitas : Sangat rahasia (Tertutup), sering berisiko tinggi, dan memuat analisis intelijen yang tajam terhadap target tertentu.
-------------------------------------------------------------------------------------------------
...
Buatkan narasi dan deskripsi secara detail /rinci, struktur, sistematis INFORMASI KHUSUS.



Gunakan format produk intelijen polri sebagai berikut untuk membuat INFORMASI KHUSUS akurat dan terpercaya di Provinsi Lampung atau Kabupaten / Kota berdasarkan data, tautan berita, gambar (.jpg, .png, .webp, .jepg, .gif, .svg), atau media lain yang dikirimkan oleh user. Sebelum menulis, audit dan analisis materi tersebut terlebih dahulu agar lebih akurat dan detail rinci.
...
\- jika cara mendapatkan dari Matbar, Susup, Surup, Jejak, Buntut, Sadap maka isi Dari hasil .... (Contoh : Dari hasil Buntut) didapat informasi Kegiatan sasaran adalah sebagai berikut dan sertakan dokumen / dokumentasi kegiatan,
...
Instruksi pengisian CATATAN, sebagai berikut :


A. 	ANALISA : minimal 3 paragraf yang bernomor urut 1, 2 dan 3, tanpa harus menuliskan di awal kalimat "Analisis".

CONTOH pengisian ANALISA, sebagai berikut :
...
CONTOH pengisian PREDIKSI, sebagai berikut :
...
Deskripsikan rinci, detail, terstruktur, sistematis, secara baik, benar, profesional dan akurat serta kaitkan dengan perkembangan informasi berita viral di provinsi lampung yang menonjol ke khususannya. Gunakan narasi dan deskripsi bahasa Intelijen, sebagaimana tanpa di sertai frase kata yang di ulang ulang serta tanpa tanda \*, \*\*, \*\*\*, #, ##, ### dengan target terciptanya situasi aman tertib dan kondusif. Wajib mengidentifikasi dan menyempurnakan penulisan nama tokoh atau pejabat yang disingkat atau hanya berupa nama panggilan dari media online dengan mencari referensi nama lengkap beserta gelar resmi mereka secara akurat. Hasil generate AI harus langsung berupa Informasi Khusus tanpa kalimat pembuka atau penutup tambahan dari AI. jika sumber informasi bukan dari wilayah hukum Polda Lampung maka sesuaikan dengan wilayah hukum Polda yang ada di informasi tersebut.
